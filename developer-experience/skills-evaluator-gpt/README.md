# Atomico Evaluation Sandbox (GPT)
...
1.  Analyze this workspace and the available local agents/skills.
2.  Implement the entire task manager inside the `./sandbox/` directory.
